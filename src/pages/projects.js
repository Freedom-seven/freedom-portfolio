  ...
  return (
    ...
    >
      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6">
        ...
        <p className="my-2 font-medium to-dark dark:text-light sm:text-sm">
          {summary}
        </p>
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col items-start justify-between mt-4">
        <span className="text-primary font-medium text-xl dark:text-primaryDark lg:text-md md:text-base">
          {type}
        </span>
        <Link
          href={link}
...
const projects = () => {
  return (
    <>
      <Head>
        <title>Freedom | Projects Page</title>
