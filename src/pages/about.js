...
const about = () => {
  return (
    <>
      <Head>
        <title>Freedom | About Page</title>
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start lg:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-meduim">
                Hi, I'm Freedom, a web developer and UI/UX designer with a
                passion for creating beautiful, functional, and user-centered
                digital experiences. With 4 years of experience in the field. I
                am always looking for new and innovative ways to bring my
                clients' visions to life.
              </p>
              <p className="font-meduim my-4">
            ...
            <div className="col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3">
              ...
              <div className="flex flex-col items-end justify-center xl:items-cente">
                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl">
